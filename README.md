...
Now the shell is running. I can list the available databases with the command `show databases`. I see the database I’ve been using: `url-shortener-microservice`.
